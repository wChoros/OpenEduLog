...
export default function Page() {
   ...
   const fetchAttendance = async () => {
      ...
      try {
         const res = await fetch(`${apiUrl}/attendance/student/${userId}`, {
            credentials: 'include',
         })
   ...
   const handleSubmitJustification = async () => {
      ...
      const apiUrl = import.meta.env.VITE_API_URL
      try {
         const res = await fetch(`${apiUrl}/attendance/justify`, {
            method: 'POST',
   ...
   if (loading && attendance.length === 0) return <div className="attendance-page"><div className="loader">Loading...</div></div>
