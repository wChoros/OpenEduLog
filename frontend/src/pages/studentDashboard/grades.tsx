...
export default function Page() {
   ...
   useEffect(() => {
      const fetchGrades = async () => {
         ...
         try {
            const res = await fetch(`${apiUrl}/grades/${userId}`, {
               credentials: 'include',
            })
            if (res.ok) {
   ...
   if (loading) return <div className="grades-page"><div className="loader">Loading your performance...</div></div>
   if (error) return <div className="grades-page">Error: {error}</div>
                  ...
                  <div key={group.subjectName} className="subject-group">
                     ...
                     <div className="grades-list">
                        {group.grades.map((grade) => {
                           ...
                           // Guess category from description or weight for eye-candy
