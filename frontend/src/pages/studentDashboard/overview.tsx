      ...
      const fetchData = async () => {
         ...
         try {
            const [annRes, gradesRes, attRes, msgRes] = await Promise.all([
               ...
               fetch(`${apiUrl}/grades/${userId}`, { credentials: 'include' }),
               fetch(`${apiUrl}/attendance/student/${userId}`, { credentials: 'include' }),
               fetch(`${apiUrl}/messages/headers/received/${userId}`, { credentials: 'include' })
            ]);
